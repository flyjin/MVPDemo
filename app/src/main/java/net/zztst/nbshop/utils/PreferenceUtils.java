...
public class PreferenceUtils {
	...
	private String SHARED_KEY_JZBACCOUNT = "shared_key_jzbaccount";;
	...
	public void setSettingJZBaccount(String zh) {
		if (zh != null && !zh.equals("null")) {
			editor.putString(SHARED_KEY_JZBACCOUNT, zh);
			editor.commit();
		}
	}

	public String getSettingJZBaccount() {
		return mSharedPreferences.getString(SHARED_KEY_JZBACCOUNT, "");
	}
}
